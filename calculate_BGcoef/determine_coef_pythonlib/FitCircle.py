...
class FitCircle_class:
    ...
    def display(self):
        ...
        ax.plot(self.x_fit2,self.y_fit2,'r-')
        plt.show()
        plt.close()
...
if __name__=="__main__":      
    x=[-1,0,0,1]
    y=[0,-1,1,0]
    fname=r'E:\workspace\Record_since_20200704\CrIS_ATMS_Match\ATMS\window_adjust\ch0\ifr47\\bm.pickle'
    ...
    print(fitcircle_obj.R_2,fitcircle_obj.xc_2,fitcircle_obj.yc_2)
    print(np.degrees(fitcircle_obj.R_2*2/824))